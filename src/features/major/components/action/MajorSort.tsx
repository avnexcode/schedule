...
export type MajorSortParams = "name" | "created_at";
export type MajorOrderParams = "asc" | "desc";

type MajorSortProps = {
  currentSort?: string;
  currentOrder?: string;
  onSortChange: (sort: MajorSortParams) => void;
  onOrderChange: (order: MajorOrderParams) => void;
};

export const MajorSort = ({
