...
type CreateLectureFormInnerProps = {
  formId: string;
  onSubmit: (values: CreateLectureFormSchema) => void;
};

export const CreateLectureFormInner = ({
  formId,
  onSubmit,
}: CreateLectureFormInnerProps) => {
  const form = useFormContext<CreateLectureFormSchema>();
  return (
    <form
      id={formId}
